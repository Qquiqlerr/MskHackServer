...
ALTER TABLE route_features
    ADD FOREIGN KEY (route_id) REFERENCES feature_types (id);
ALTER TABLE route_features
    ADD FOREIGN KEY (feature_id) REFERENCES routes (id);
ALTER TABLE visit_permits
    ADD FOREIGN KEY (status) REFERENCES permit_statuses (id);
ALTER TABLE visit_permits
    ADD FOREIGN KEY (route_id) REFERENCES routes (id);
ALTER TABLE visit_permits
    ADD FOREIGN KEY (group_id) REFERENCES group_permits (id);
ALTER TABLE visit_permits
    ADD FOREIGN KEY (visit_reason) REFERENCES visit_reasons (id);
ALTER TABLE visit_permits
    ADD FOREIGN KEY (visit_format) REFERENCES visit_format (id);
ALTER TABLE reports
    ADD FOREIGN KEY (type) REFERENCES type_of_reports (id);
ALTER TABLE reports
    ADD FOREIGN KEY (statusID) REFERENCES reports_statuses (id);
